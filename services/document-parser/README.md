...
spec:
  ...
  template:
    spec:
      containers:
      - name: document-parser
        image: ai-underwriter/document-parser:v1.0.0
        ports:
        - containerPort: 8003
        env:
        - name: PARSER_ENVIRONMENT
          value: "production"
        resources:
          requests:
            memory: "1Gi"
...
- [ ] Configure production Gemini credentials
- [ ] Set up production database
- [ ] Configure AWS resources (SQS, S3)
...
1. Check the logs: `docker logs document-parser`
2. Verify configuration: `curl /api/v1/health`
3. Review metrics: `curl /api/v1/health/metrics`
4. Contact the development team

## License

Proprietary - AI Underwriter Team